...
Module to populate a GitOps repo with a pull secret. The secret is encrypted with a Kube Seal certificate to protect the information in the GitOps repo.
